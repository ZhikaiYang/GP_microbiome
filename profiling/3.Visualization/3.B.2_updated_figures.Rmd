...
sinfo_asv_isnp = sinfo_microbiome_geno[,c(1:6,id_asv_isnp)]
...
psn_s <- ggplot(sinfo_pheno_asv_isnp[id_02,], aes(x=sinfo_pheno_asv_isnp$asv_000143[id_02], y=sinfo_pheno_asv_isnp$Aug12[id_02], color=sinfo_pheno_asv_isnp$nitrogen[id_02])) + 
    geom_point()+
    geom_smooth(method=lm) +
    xlab("") +
    ylab("") +
