...
f <- list.files(path="largedata/review/output_yieldc", pattern="prediction_accuracy_5fold_seed.*_3626asvs_spb", full.names = T)
fn <- list.files(path="largedata/review/output_yieldc", pattern="prediction_accuracy_5fold_seed.*_nitrogen_.*_3626asvs_spb", full.names = T)
...
out = out[-id_pc,]
fwrite(out[,-7], "largedata/review/pred_seeds_yieldc_shuffled_sample_names_3626asvs_spb.txt", sep = "\t", quote = F, row.names = F, col.names = T)
...
```{r}
library(data.table)
f <- list.files(path="largedata/review/output_yieldc", pattern="prediction_accuracy_5fold_seed.*_nitrogen_.*_3626asvs_spb", full.names = T)
...
id_pc = which(out$method == "rrBLUP_PC_microbiome")
out = out[-id_pc,]
fwrite(out[,-7], "largedata/review/pred_seeds_yieldc_nitrogen_shuffled_sample_names_3626asvs_spb.txt", sep = "\t", quote = F, row.names = F, col.names = T)
