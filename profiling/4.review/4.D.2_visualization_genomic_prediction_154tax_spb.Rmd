...
f <- list.files(path="largedata/review/output_154Functional_Tax_Groupes", pattern="prediction_accuracy_seed.*_154tax_spb", full.names = T)

fn <- list.files(path="largedata/review/output_154Functional_Tax_Groupes", pattern="prediction_accuracy_seed.*_nitrogen_.*_154tax_spb", full.names = T)

fq <- list.files(path="largedata/review/output_154Functional_Tax_Groupes", pattern="prediction_accuracy_seed.*_shuffled_quadrant_yes.*_154tax_spb", full.names = T)
...
out$shuffled  <- gsub(".*shuffled_|_154tax_spb.*", "", out$file)

id_pc = which(out$method == "rrBLUP_PC_microbiome")
out = out[-id_pc,]


fwrite(out[,-7], "largedata/review/pred_seeds_vis_shuffled_154Functional_Tax_Groupes_spb_nlogrel.txt", sep = "\t", quote = F, row.names = F, col.names = T)
...
pred_all = fread("largedata/review/pred_seeds_vis_shuffled_154Functional_Tax_Groupes_spb.txt", header = T)
...
f <- list.files(path="largedata/review/output_154Functional_Tax_Groupes", pattern="prediction_accuracy_seed.*_shuffled_quadrant_yes.*_154tax_spb", full.names = T)
...
id_r = which((out$method == "rrBLUP_PC_microbiome") | (out$method == "rrBLUP"))
out = out[-id_r,]


fwrite(out[,-7], "largedata/review/pred_seeds_vis_shuffled_quandrant_yes_154Functional_Tax_Groupes_spb.txt", sep = "\t", quote = F, row.names = F, col.names = T)
...
pred_quadrant = fread("largedata/review/pred_seeds_vis_shuffled_quandrant_yes_154Functional_Tax_Groupes_spb.txt", header = T)
...
pred_all_avg$method <- factor(pred_all_avg$method, levels = c( "rrBLUP", "rrBLUP_geno_microbiome", "rrBLUP_geno_shuffled_microbiome", "rrBLUP_geno_shuffled_microbiome_quadrant"), labels =c( "SNP", "SNP + ASV", "SNP + shuffled ASV by sample names", "SNP + shuffled ASV by sample names within quadrant"))
...
my_comparisons <- list(c("SNP", "SNP + ASV"), c("SNP", "SNP + shuffled ASV by sample names"),  c("SNP + shuffled ASV by sample names", "SNP + shuffled ASV by sample names within quadrant"))
...
p_vari_shuffled = ggarrange(p_vari_shuffled_aug12, p_vari_shuffled_aug22, p_vari_shuffled_sep5, nrow = 3, ncol = 1)
...
```{r}
library(data.table)
f <- list.files(path="largedata/review/output_154Functional_Tax_Groupes", pattern="prediction_accuracy_seed.*_nitrogen_.*_154tax_spb", full.names = T)
...
fwrite(out[,-7], "largedata/review/pred_seeds_nitrogen_vis_shuffled_names_154tax_spb.txt", sep = "\t", quote = F, row.names = F, col.names = T)
...
```{r}
pred_all_nitrogen = fread("largedata/review/pred_seeds_nitrogen_vis_shuffled_names_154tax_spb.txt", data.table = F)
...
f <- list.files(path="largedata/review/output_154Functional_Tax_Groupes", pattern="coef_mic_trait.*_spb", full.names = T)
fn <- list.files(path="largedata/review/output_154Functional_Tax_Groupes", pattern="coef_mic_trait.*_nitrogen_.*_spb", full.names = T)
f = f[-which(f %in% fn)]
...
fwrite(out, "largedata/review/coef_mic_all_traits_dates_154tax_spb.txt", sep = "\t", quote = F, row.names = F, col.names = T)
...
f <- list.files(path="largedata/review/output_154Functional_Tax_Groupes", pattern="coef_mic_trait.*_nitrogen_.*_spb", full.names = T)
...
fwrite(out, "largedata/review/coef_mic_all_traits_dates_nitrogen_154tax_spb.txt", sep = "\t", quote = F, row.names = F, col.names = T)
...
#top abs_scaled asvs
```{r}
coef_all = fread("largedata/review/coef_mic_all_traits_dates_154tax_spb.txt", data.table = F)
out <- data.frame()
...
coef_vis = fread("largedata/review/coef_mic_all_traits_dates_nitrogen_154tax_spb.txt", data.table = F)
