...
f <- list.files(path="largedata/review/output_19classes", pattern="prediction_accuracy_seed", full.names = T)
...
out = out[-id_pc,]
fwrite(out[,-7], "largedata/review/pred_seeds_vis_shuffled_no_19classes.txt", sep = "\t", quote = F, row.names = F, col.names = T)
...
pred_all = fread("largedata/review/pred_seeds_vis_shuffled_no_19classes.txt", header = T)
