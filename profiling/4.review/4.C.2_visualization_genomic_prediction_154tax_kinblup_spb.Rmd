...
f <- list.files(path="largedata/review/output_154Functional_Tax_Groupes", pattern="prediction_accuracy_seed.*_kinblup_spb", full.names = T)
...
fwrite(out[,-7], "largedata/review/pred_seeds_vis_shuffled_154Functional_Tax_Groupes_kinblup_spb.txt", sep = "\t", quote = F, row.names = F, col.names = T)
...
pred_all = fread("largedata/review/pred_seeds_vis_shuffled_154Functional_Tax_Groupes_kinblup_spb.txt", header = T)
...
pred_all_avg = pred_all_avg[-which(pred_all_avg$shuffled == "snps_yes"),]
...
```{r}
library(data.table)
f <- list.files(path="largedata/review/output_154Functional_Tax_Groupes", pattern="prediction_accuracy_seed.*_nitrogen_.*_kinblup_spb", full.names = T)
...
fwrite(out[,-7], "largedata/review/pred_seeds_nitrogen_vis_shuffled_names_154tax_kinblup_spb.txt", sep = "\t", quote = F, row.names = F, col.names = T)
...
pred_all_nitrogen_avg = pred_all_nitrogen_avg[-which(pred_all_nitrogen_avg$shuffled == "yes"),]


pred_all_nitrogen_avg$method[which((pred_all_nitrogen_avg$method == "rrBLUP_geno_microbiome") & (pred_all_nitrogen_avg$shuffled == "snps_yes"))] = "rrBLUP_shuffled_snps_microbiome"

pred_all_nitrogen_avg$method[which((pred_all_nitrogen_avg$method == "rrBLUP") & (pred_all_nitrogen_avg$shuffled == "snps_yes"))] = "rrBLUP_shuffled_snps"




pred_all_nitrogen_avg$method <- factor(pred_all_nitrogen_avg$method, levels = c( "rrBLUP", "rrBLUP_shuffled_snps", "rrBLUP_geno_microbiome", "rrBLUP_shuffled_snps_microbiome"), labels =c( "SNP", "shuffled SNP","SNP + ASV", "shuffled SNP + ASV "))
...
my_comparisons <- list(c("SNP", "shuffled SNP"), c("SNP", "SNP + ASV"), c("SNP + ASV", "shuffled SNP + ASV "))
