...
wilcox.test(date_asv_mic_group_top1_anno_HN$Selection_coeff[which((date_asv_mic_group_top1_anno_HN$top1p == 0) & (date_asv_mic_group_top1_anno_HN$date == "Aug-12"))], date_asv_mic_group_top1_anno_HN$Selection_coeff[which((!(date_asv_mic_group_top1_anno_HN$top1p == 0)) & (date_asv_mic_group_top1_anno_HN$date == "Aug-12"))])

wilcox.test(date_asv_mic_group_top1_anno_HN$Selection_coeff[which((date_asv_mic_group_top1_anno_HN$top1p == 0) & (date_asv_mic_group_top1_anno_HN$date == "Aug-22"))], date_asv_mic_group_top1_anno_HN$Selection_coeff[which((!(date_asv_mic_group_top1_anno_HN$top1p == 0)) & (date_asv_mic_group_top1_anno_HN$date == "Aug-22"))])

wilcox.test(date_asv_mic_group_top1_anno_HN$Selection_coeff[which((date_asv_mic_group_top1_anno_HN$top1p == 0) & (date_asv_mic_group_top1_anno_HN$date == "Sep-5"))], date_asv_mic_group_top1_anno_HN$Selection_coeff[which((!(date_asv_mic_group_top1_anno_HN$top1p == 0)) & (date_asv_mic_group_top1_anno_HN$date == "Sep-5"))])
...
wilcox.test(date_asv_mic_group_top1_anno_LN$Selection_coeff[which((date_asv_mic_group_top1_anno_LN$top1p == 0) & (date_asv_mic_group_top1_anno_LN$date == "Aug-12"))], date_asv_mic_group_top1_anno_LN$Selection_coeff[which((!(date_asv_mic_group_top1_anno_LN$top1p == 0)) & (date_asv_mic_group_top1_anno_LN$date == "Aug-12"))])

wilcox.test(date_asv_mic_group_top1_anno_LN$Selection_coeff[which((date_asv_mic_group_top1_anno_LN$top1p == 0) & (date_asv_mic_group_top1_anno_LN$date == "Aug-22"))], date_asv_mic_group_top1_anno_LN$Selection_coeff[which((!(date_asv_mic_group_top1_anno_LN$top1p == 0)) & (date_asv_mic_group_top1_anno_LN$date == "Aug-22"))])

wilcox.test(date_asv_mic_group_top1_anno_LN$Selection_coeff[which((date_asv_mic_group_top1_anno_LN$top1p == 0) & (date_asv_mic_group_top1_anno_LN$date == "Sep-5"))], date_asv_mic_group_top1_anno_LN$Selection_coeff[which((!(date_asv_mic_group_top1_anno_LN$top1p == 0)) & (date_asv_mic_group_top1_anno_LN$date == "Sep-5"))])
