...
pred_all = fread("largedata/review/pred_seeds_vis_shuffled_sample_names_3626asvs_spb_from_count.txt", header = T)
...
pdf("largedata/review/figures/p_vari_shuffled_spb2.pdf", width = 13, height= 6)
p_vari_shuffled
dev.off()
