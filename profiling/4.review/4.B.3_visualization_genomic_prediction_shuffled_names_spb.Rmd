...
f <- list.files(path="largedata/review/output_shuffled_sample_names", pattern="prediction_accuracy_seed.*_spb", full.names = T)

fn <- list.files(path="largedata/review/output_shuffled_sample_names", pattern="prediction_accuracy_seed.*_nitrogen_.*_spb", full.names = T)
...
fwrite(out[,-7], "largedata/review/pred_seeds_vis_shuffled_sample_names_3626asvs_spb.txt", sep = "\t", quote = F, row.names = F, col.names = T)
...
fwrite(out, "largedata/review/coef_mic_all_traits_dates_nitrogen_3626asvs.txt", sep = "\t", quote = F, row.names = F, col.names = T)
...
#top abs_scaled asvs
```{r}
coef_vis = fread("largedata/review/coef_mic_all_traits_dates_nitrogen_3626asvs.txt", data.table = F)
