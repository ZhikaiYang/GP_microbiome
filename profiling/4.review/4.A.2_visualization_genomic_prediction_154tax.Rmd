...
f <- list.files(path="largedata/review/output_154Functional_Tax_Groupes", pattern="prediction_accuracy_seed", full.names = T)
...
out = out[-id_pc,]
fwrite(out[,-7], "largedata/review/pred_seeds_vis_shuffled_no_154Functional_Tax_Groupes.txt", sep = "\t", quote = F, row.names = F, col.names = T)
...
pred_all = fread("largedata/review/pred_seeds_vis_shuffled_no_154Functional_Tax_Groupes.txt", header = T)
